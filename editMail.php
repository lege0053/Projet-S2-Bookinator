...
$webPage = new WebPage("Modifier l'adresse mail");
...
<div class="d-flex flex-row justify-content-center margin-topbottom-art">
    ...
    <div class="d-flex flex-column main-background padding-button border-radius-5">
        <div class="login-form">
            <form action="trmt/editMail_trmt.php" method="post" class="padding-button">
                <div class="d-flex flex-row justify-content-center">
                    <div class="form-group d-inline-flex">
                        <h2 class="form-title white-text-color">Changement d'adresse mail</h2>
                    </div>
                </div> 
                <div class="form-group d-flex flex-column">
                    <div class="white-text-color">Nouvelle adresse mail</div>
                    <input type="email" name="mail" class="form-control second-main-background font-size-10 white-text-color" required>
                </div>
                <div class="form-group d-flex flex-column">
                     <div class="white-text-color">Confirmation de la nouvelle adresse mail</div>
