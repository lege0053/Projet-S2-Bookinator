...
function printResearchBookAdmin(String $ISBN) {
    ...
    <div class="d-flex flex-row main-background border-radius-5 m-4">
       ...
       <div class="d-flex flex-column justify-content-center  align-items-end-center">
            <a href="editBook.php?isbn={$book->getISBN()}" class="btn font-size-15 main-color-background dark-text border-radius-5 padding-button font-weight-bold button">Éditer </a>
            <form action="trmt/deleteBookAdmin_trmt.php" method="post">
