...
function getIndexHeader() : String
{
    ...
    $header = <<<HTLM
        <div class="header d-flex align-items-center p-1 justify-content-between">
...
{
    $header = <<<HTML
        <div class="header d-flex main-background align-items-center p-1 justify-content-between">
            <div class="d-flex align-items-center">
                <div class="font-size-24 white-text-color m-1"><img class="logo m-2" src="img/logo-48.png" width="48">Bookinator</div>
    ...
    if(isLogged()) {
        $header .= <<<HTML
           <div class="d-flex align-items-center">
                ...
                <a href="profile.php" class="font-size-24 main-color-background dark-text border-radius-5 padding-button font-weight-bold button">Profil</a>
        HTML;
        if(isAdmin()) {
            $header .= <<<HTML
