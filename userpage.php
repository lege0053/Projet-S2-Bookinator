...
$html = <<<HTML
    <div>
        ...
        <img alt="" src="{$user->getPhotoProfil()}">
        <div class="font-size-24 main-color-background dark-text border-radius-5 padding-button font-weight-bold">Profil</div>
    </div>
    <div>
        <a href="favoris.php" class="font-size-24 main-color-background dark-text border-radius-5 padding-button font-weight-bold button">Mes Favoris</a>
        <form action="disconnect.php" method="post">
            <button type="submit" class="btn font-size-24 main-color-background dark-text border-radius-5 padding-button font-weight-bold button">Se déconnecter</button>
        </form>
    </div>
HTML;
...
$form = <<<HTML
    ...
    <div class="profil-form">
        ...
        <form action="profil_trmt.php" method="post">
            ...
            <div class="form-group">
                <button type="submit" class="form_submit">Sauvegarder</button>
            </div>
        </form>
